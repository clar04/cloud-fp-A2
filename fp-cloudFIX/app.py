...
app.config['MONGO_URI'] = 'mongodb+srv://doadmin:X20Uu97a8F3j46Wg@db-mongodb-sgp1-38511-e14da84d.mongo.ondigitalocean.com/admin?tls=true&authSource=admin&replicaSet=db-mongodb-sgp1-38511'
mongo = PyMongo(app)
